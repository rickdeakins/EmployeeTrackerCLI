...
function editEmployee(employeeId, revisedDetails) {
  ...
  connection.query(sqlQuery, [
    revisedDetails.editFirstName,
    revisedDetails.editLastName,
    revisedDetails.editRoleTitle,
    revisedDetails.editSalary,
    revisedDetails.editDepartmentName,
    revisedDetails.editManagerId,
    employeeId,
  ]),
    (err, res) => {
      if (err) throw err;
